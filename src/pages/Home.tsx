...
import { ArrowRight, Bot, Brain, Eye, Workflow, Shield, Clock, Wheat, Mountain, Truck, Factory, CheckCircle, Cpu, Database, LineChart, Users, DollarSign, Gift } from 'lucide-react';
  ...
  return (
    <>
      ...
      <section className="relative pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden">
        ...
        {/* Animated background elements - Keeping CSS animation for continuous background effects */}
        ...
        <motion.div
          ...
          className="absolute bottom-1/3 right-1/4 w-32 h-32 bg-cyan-200 rounded-full mix-blend-multiply filter blur-xl"
        />
          ...
          >
            {agentTypes.map((agent, index) => (
              <motion.div
                ...
                className="group p-6 bg-gradient-to-br from-white to-indigo-50 rounded-2xl border border-gray-100 hover:border-indigo-300 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              ...
              className="group bg-white rounded-2xl p-8 shadow-lg border-l-4 border-indigo-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500"
            >
          ...
          >
            {industrias.map((industria, index) => (
              ...
              >
                <Link
                  to={industria.href}
                  className="block h-full group p-6 bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300"
                >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-br from-indigo-600 to-blue-700 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden"
          >
            {/* Logo watermark */}
